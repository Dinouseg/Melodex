"""WaveQueen Downloader - desktop music downloader.
...
tracks land on disk tagged and ready for WaveQueen.
...
class App:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(
            titles,
            text="Fetch music for WaveQueen from Tidal, Spotify, Deezer, YouTube "
    ...
    def start(self) -> None:
        ...
        try:
            ...
            probe = os.path.join(out_dir, ".wavequeen-write-test")
